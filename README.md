...
Inputs - cube is 3D cube of star, used for both telluric and flux calibration. ox, oy, or
- center and radius of aperture, r2 - radius of annulus (r1->r2) of background. mx, my, mr - center and radius of mask, if not required then mx=0. mask - any other mask required (2D fits)
